...
import GraphicsCardPageProps from "./interfaces/GraphicsCardPageProps";

async function GraphicsCardPage({ params, searchParams }: GraphicsCardPageProps) {
  const graphicsCard: GraphicsCard = (
    await axios.get(`http://localhost:5555/products-api/electronics/graphicsCards/${params.id}`)
  ).data;
