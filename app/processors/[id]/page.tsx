...
import ProcessorPageProps from "./interfaces/ProcessorPageProps";

async function ProcessorPage({ params, searchParams }: ProcessorPageProps) {
  const graphicsCard: Processor = (
    await axios.get(`http://localhost:5555/products-api/electronics/processors/${params.id}`)
  ).data;
